...
void NasSm::sendEstablishmentRequest(const SessionConfig &config)
{
    ...
    /* Make PCO */
    bool wantsIpv4 = config.type == nas::EPduSessionType::IPV4 || config.type == nas::EPduSessionType::IPV4V6;
    bool wantsIpv6 = config.type == nas::EPduSessionType::IPV6 || config.type == nas::EPduSessionType::IPV4V6;
    ...
    {
        opt.additionalParams.push_back(std::make_unique<nas::ProtocolConfigurationItem>(
            nas::EProtocolConfigId::CONT_ID_DOWN_DNS_SERVER_IPV6_ADDRESS, true, OctetString::Empty()));
    }
